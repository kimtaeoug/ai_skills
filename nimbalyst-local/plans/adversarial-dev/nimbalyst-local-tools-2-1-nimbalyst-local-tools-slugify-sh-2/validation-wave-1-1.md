...
```
bash tests/test-evolve.sh && bash tests/test-hooks.sh
```

Result: **PASS** (both scripts exited 0)
...
- `tests/test-evolve.sh`: 11/11 checks passed, exit code 0.
- `tests/test-hooks.sh`: 7/7 checks passed, exit code 0.
